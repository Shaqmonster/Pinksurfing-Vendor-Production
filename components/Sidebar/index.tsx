  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-2 pt-5.5 lg:py-2.5 lg:pt-6.5">
        <Link href="/" className="normal-case text-xl flex flex-row items-center font-bold text-white">
        <Image
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/inventory/products" && "text-white"
                              } `}
                            >
                              Products
                            </Link>
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/inventory/add_products" && "text-white"
                              } `}
                            >
                              Add Products
                            </Link>
